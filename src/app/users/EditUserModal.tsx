...
export default function EditUserModal({ open, data: initialValues, onClose }: { open: boolean, data: any, onClose: any }) {
    ...
    <Modal title="Editar Usuarios" maxWidth="700px" open={open} onClose={onClose}>
      <Stack rowGap={"20px"} direction="column" mb="24px">
        ...
        <Stack columnGap={"20px"} direction="row" justifyContent="space-between">
          ...
          <Field label="Validez" disabled width={166} value={currentState?.validity} />
        </Stack>
      </Stack>
      ...
      <Stack direction="row" justifyContent="space-between" mb="20px" mt="24px" alignItems="center">
        ...
        <Stack direction="row" gap="20px">
          <Field label="Clase (A-Z)" width={183} value={currentState?.class} onChange={(value: any) => onChange("class", value)} />
